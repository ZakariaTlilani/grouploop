    ...
    grouploop: function (i) {
      ...
      return (
        ...
        r.forward
          ? ((n = -d),
            f(o).each(function (i, n) {
              f(n)
                .find(r.childWrapper)
                .each(function (i, n) {
                  f(f(n).find(f(r.childNode).get().reverse())).each(
                    function () {
          ...
          : ((n =
              "none" !== f(o).find(r.childWrapper).css("transform")
                ? f(o)
                    .find(r.childWrapper)
                    .css("transform")
                    .split(/[()]/)[1]
